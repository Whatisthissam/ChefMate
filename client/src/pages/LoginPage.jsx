        ...
        <div className="w-full max-w-md">
          <div className="rounded-2xl border border-black/10 bg-white/70 p-7 shadow-[0_18px_60px_rgba(0,0,0,0.18)] backdrop-blur-sm dark:border-white/10 dark:bg-white/5 dark:shadow-[0_18px_60px_rgba(0,0,0,0.55)]">
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="mt-2 text-2xl font-extrabold tracking-tight">Login</h2>
              <p className="mt-1 text-sm text-[#2b1f16]/70 dark:text-neutral-300">Welcome back. Continue discovering recipes.</p>
            </div>
            ...
            <form className="mt-6 grid gap-3" onSubmit={onSubmit}>
              ...
              <div className="flex items-center justify-end">
                <button type="button" className="text-xs text-black/55 hover:text-black/75 dark:text-white/45 dark:hover:text-white/70">
                  Forgot password?
                </button>
              </div>
